...
static struct lwm2m_engine_obj_inst *buzzer_create(u16_t obj_inst_id)
{
	...
	buzzer_data[avail].level.val2 = 0;
	buzzer_data[avail].delay_duration.val1 = 1; /* 1 seconds */
	buzzer_data[avail].delay_duration.val2 = 0;
	buzzer_data[avail].min_off_time.val1 = 0;
	buzzer_data[avail].min_off_time.val2 = 0;
	buzzer_data[avail].trigger_offset = 0U;
	buzzer_data[avail].onoff = false;
	buzzer_data[avail].active = false;
